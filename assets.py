...
class GameAssets:
    ...
    def load(self):
        try:
            self.trumpet = test.cut_sprite_sheet(resource_path("graphics/trumpet.png"),32,32)
            self.background = pygame.image.load(resource_path("graphics/menu/background.png"))
            self.note_sounds_5 = {
            ...
            self.note_pictures_help = {
                "4": pygame.transform.scale(pygame.image.load(resource_path("graphics/quarter.png")).convert_alpha(), (172, 172)),
                "8": pygame.transform.scale(pygame.image.load(resource_path("graphics/half.png")).convert_alpha(), (172, 172)),
                "16": pygame.transform.scale(pygame.image.load(resource_path("graphics/whole.png")).convert_alpha(), (172, 172)),
            }
            self.note_pictures = {
                "4": pygame.transform.scale(pygame.image.load(resource_path("graphics/quarter2.png")).convert_alpha(), (172, 172)),
                "8": pygame.transform.scale(pygame.image.load(resource_path("graphics/half2.png")).convert_alpha(), (172, 172)),
                "16": pygame.transform.scale(pygame.image.load(resource_path("graphics/whole2.png")).convert_alpha(), (172, 172)),
                "g": pygame.transform.scale(pygame.image.load(resource_path("graphics/g.png")).convert_alpha(), (172, 172)),
            }
        except (pygame.error, FileNotFoundError):
            error.handle_error("Menu background img not found","not_fatal")
            self.background = pygame.Surface((1280, 720))
